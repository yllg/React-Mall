...
class Main extends Component {
    ...
    render() {
        ...
        return (
            <div ref='Container' className="component_container EmploymentDetail_module">
                <Header />
                <h1>
                    当代商城
                ...
                <div className="contentWrap">
                    ...
                    <br/>
                    <Link to='/application' className="onlineApplica">
                        <span>在线申请</span>
                    </Link>
                </div>
...
export default template({
    id: 'EmploymentDetail',  //应用关联使用的redux
    component: Main, //接收数据的组件入口
    url: '/getEmploymentDetailData',
    data: {}
});
